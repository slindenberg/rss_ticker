...
bool Win32Window::Create(const std::wstring& title,
  ...
  SetWindowLong(window, GWL_EXSTYLE, ex_style | WS_EX_LAYERED);
  ...
  abd.rc.bottom = Scale(30, scale_factor);
  ...
  SetWindowPos(window, HWND_TOPMOST, 0, 0,
               GetSystemMetrics(SM_CXSCREEN), scaled_height,
